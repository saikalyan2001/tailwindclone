...
const AddtobagModal = ({ Data,isQuickView, setIsQuickView }) => {
  
  const { image, title, price, original_price, discount, sizes } = Data;
      ...
      <div className="fixed z-20 top-1/2 left-1/2 transform  -translate-x-1/2 -translate-y-1/2 flex flex-col  gap-10 bg-white  overflow-auto  rounded-xl w-3/4 h-3/4">
        ...
        <div className="flex gap-5 ml-5">
          <div className="flex flex-col gap-3">
            <img src={image} alt="img" className="w-20 rounded-md" />
            <img src={image} alt="img" className="w-20 rounded-md" />
            <img src={image} alt="img" className="w-20 rounded-md" />
            <img src={image} alt="img" className="w-20 rounded-md" />
            <img src={image} alt="img" className="w-20 rounded-md" />
